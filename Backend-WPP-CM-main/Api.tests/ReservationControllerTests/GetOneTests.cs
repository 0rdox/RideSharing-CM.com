...
namespace Api.tests.ReservationControllerTests {
    public class GetOneTests : IDisposable {
        ...
        [Fact]
        public void get_with_id_of_not_exising_reservation_returns_not_found() {
            //Arrange
        ...
        [Fact]
        public void get_with_id_of_exising_reservation_returns_reservation_with_OK() {
            //Arrange
            repository.GetById(Arg.Any<int>()).Returns(new Reservation {
                id = 1,
